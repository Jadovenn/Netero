...
netero::graphics::Application* netero::graphics::Application::Initialize(const std::string& ApplicationName) {
...
netero::graphics::Context* netero::graphics::Application::newWindowedContext(unsigned width,
    unsigned height,
