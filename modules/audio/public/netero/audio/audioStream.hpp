...
class AudioStream {
    ...
    netero::audio::DeviceErrorSlot
        deviceErrorSlot; /**< Slot used to notify the user a device error. */
    netero::audio::OnDisconnectedSlot
        deviceDisconnectedSlot; /**< Slot used to notify the user that the device has been disconnected. */
    netero::audio::OnFormatChangeSlot
        formatChangedSlot; /**< Slot used to notify the user that the stream format has changed. */
