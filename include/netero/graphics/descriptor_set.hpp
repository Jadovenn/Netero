...
class DescriptorSets {
     ...
     */
    Error write(Descriptor&  descriptor,
                int          setIdx,
                VkBuffer     buffer,
                VkDeviceSize offset,
                VkDeviceSize range);
    ...
    const uint32_t _descriptorCountPerSet =
        1; /**< Number of descriptor(s) of the same type in a set. Might be configurable in the future. */
